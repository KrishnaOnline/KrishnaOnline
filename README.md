...
## 💻 Tech Stack:
![My Skills](https://skillicons.dev/icons?i=ts,js,cpp,java,nodejs,react,nextjs,expressjs,postgresql,mysql,prisma,mongodb,aws,redux,tailwind,html,css,git,github,githubactions,postman,docker,vite&theme=dark)
